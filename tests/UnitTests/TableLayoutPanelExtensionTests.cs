...
namespace UnitTests
{
    public class TableLayoutPanelExtensionTests
    {
        ...
        private void CanSet_RowStyles()
        {
            ...
            Assert.True(panel.RowStyles[0].SizeType == SizeType.AutoSize);
        ...
        private void CanSet_TableControls()
        {
            ...
            Assert.StrictEqual(info[0], new {Col = 0, Row = 0, ColSpan = 1, RowSpan = 1});
            Assert.StrictEqual(info[1], new {Col = 1, Row = 0, ColSpan = 2, RowSpan = 1});
            Assert.StrictEqual(info[2], new {Col = 0, Row = 1, ColSpan = 3, RowSpan = 2});
        }
